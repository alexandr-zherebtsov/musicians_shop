                                ...
                                : Padding(
                                    ...
                                    child: AnimatedSwitcher(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        key: ValueKey<String>(controller.advert
                                            .images![controller.selectedImage]),
                                        child: AppNetworkImage(
                                          height: 540,
                                          width: double.infinity,
                                          url: controller.advert.images![
                            ...
                            (controller.advert.images ?? []).isEmpty
                                ...
                                : SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount:
                                          controller.advert.images!.length,
                                      itemBuilder: (_, int i) {
                                        return Padding(
                                          padding: const EdgeInsets.symmetric(
                                            horizontal: 4,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    LikesWidget(
                                      likes:
                                          controller.advert.likes?.length ?? 0,
                                      liked: controller.advert.likes
                                              ?.contains(controller.uid) ??
                                          false,
